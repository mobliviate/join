                                ...
                                <div class="summary_buttons summary_button_width_264 gap_16" id="summary-todo">
                                    ...
                                    <div class="summary_image_wrapper">
                                        <svg width="69" height="70" viewBox="0 0 69 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle class="hover-white" cx="34.5" cy="35" r="34.5" fill="#2A3647"/>
                                ...
                                <div class="summary_buttons summary_button_width_264 gap_16" id="summary-done">
                                    ...
                                    <div class="summary_image_wrapper">
                                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle class="hover-white" cx="35" cy="35" r="34.5" fill="#2A3647"/>
                                            <path class="hover-stroke-main-color" d="M20.0283 35.0001L31.2571 46.0662L49.9717 23.9341" stroke="white" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </div>                                
